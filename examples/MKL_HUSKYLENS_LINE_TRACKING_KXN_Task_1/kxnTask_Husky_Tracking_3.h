...
DEFINE_TASK_STATE(kxnTask_Husky_Tracking){
  ...
  kxnTask_Husky_Tracking_Object_RUN_X,
  kxnTask_Husky_Tracking_Object_RUN_Y,
...
float scale1_Track_Object = 70;
float scale2_Track_Object = 70;
float scale3_Track_Object = 70;
...
void GetDataThenTrackingObject() {
  ...
  switch (this->state_TrackingObject)
  {
  case kxnTask_Husky_Tracking_Object_RUN_X:
    trackingObjectProcess_X(error);
    this->state_TrackingObject = kxnTask_Husky_Tracking_Object_RUN_Y;
    break;
  case kxnTask_Husky_Tracking_Object_RUN_Y:
    trackingObjectProcess_Y(error_Y);
    this->state_TrackingObject = kxnTask_Husky_Tracking_Object_RUN_X;
    break;
  default:
    this->state_TrackingObject = kxnTask_Husky_Tracking_Object_RUN_X;
    break;
...
bool trackingObjectProcess_X(int pos_pa){
  ...
  tempPos1 = constrain(tempPos1, -1, 1);
